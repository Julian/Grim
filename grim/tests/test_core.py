...
class TestPawn(TestCase):
    ...
    def test_it_can_move_forward(self, data):
        empty = core.Board(contents=pmap())
        ...
        self.assertEqual(moved, core.Board(contents=pmap({end: core.Pawn()})))
